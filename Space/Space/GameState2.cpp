...
GameState2::GameState2(Ndk::World & world)
	: m_world(world)
{
	createShip();
	createBackground();
...
void GameState2::Enter(Ndk::StateMachine& fsm)
{

}

void GameState2::Leave(Ndk::StateMachine& fsm)
{

}

bool GameState2::Update(Ndk::StateMachine& fsm, float elapsedTime)
{
	return true;
}

void GameState2::createShip()
{
...
void GameState2::createBackground()
{
	Ndk::EntityHandle entity = m_world.CreateEntity();
	Ndk::NodeComponent& nodeComponent = entity->AddComponent<Ndk::NodeComponent>();
	Ndk::GraphicsComponent& graphicComponent = entity->AddComponent<Ndk::GraphicsComponent>();
